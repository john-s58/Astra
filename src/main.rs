...
//     }
//     println!("Cluster 1 test post training Output: {:#?}", my_net.feed_forward(&array![-0.5f64, -0.5f64]));
//     println!("Cluster 2 test post training Output: {:#?}", my_net.feed_forward(&array![0.5f64, 0.5f64]));
//     println!("Cluster 3 test post training Output: {:#?}", my_net.feed_forward(&array![1.5f64, 1.5f64]));
